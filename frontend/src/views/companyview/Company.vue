...
const deleteItem = (id) => {
    axios.delete(`http://127.0.0.1:8000/company/delete/${id}`).then(res=> {
        location.reload()
...
<template>
  <DefaultLayout>
    ...
    <!-- Breadcrumb End -->
    <div class="mb-5">
        <RouterLink class="w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 font-medium text-white transition hover:bg-opacity-90" :to="{name: 'company-add'}">Add Company</RouterLink>
    </div>
    ...
    >
        ...
        <table class="w-full table-auto">
            ...
            <tr class="bg-gray-2 text-left dark:bg-meta-4">
                ...
                <th class="min-w-[120px] py-4 px-4 font-medium text-black dark:text-white"> Company Phone</th>
                <th class="min-w-[120px] py-4 px-4 font-medium text-black dark:text-white">Contract Expiration</th>
                </tr>
            </thead>
            <tbody>
            <tr v-for="(item, index) in company" :key="index">
                ...
                <div class="flex items-center space-x-3.5">
                    <RouterLink :to="{'name':'company-edit','params':{'id':item.id}}" class="hover:text-primary">
                    <svg
                        class="fill-current"
                        width="18"
                        height="18"
                    ...
                    <div v-if="showModal" class="overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center flex">
                        <div class="relative w-auto my-6 mx-auto max-w-sm">
                            ...
                            <div class="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
                                ...
                                Delete Auditor {{ selectedItem.first_name }} {{ selectedItem.last_name }}?
                                </h3>
