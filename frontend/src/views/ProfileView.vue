...
onMounted(async ()=>{
  await axios.get(`http://127.0.0.1:8000/get-auditor-profile/`, {
    headers: {
...
const submit = async () => {
  ...
  await axios.post(`http://127.0.0.1:8000/get-auditor-profile/`, {
    ...
    // router.push({name: 'auditors-view'})
...
<template>
  <DefaultLayout>
    <div class="mx-auto max-w-242.5">
      ...
      >
        <form class="px-4 py-6 text-center lg:pb-8 xl:pb-11.5">
        ...
        <div class="mb-4">
          <label class="mb-2.5 block font-medium text-black dark:text-white">Specializations</label>
          <div class="relative">
            <input
              type="text"
